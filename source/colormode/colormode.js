...
function colorSwitcher() {
    ...
    function showThemeIcon(elem, theme) {
        if (theme === 'light')
    ...
    if (colorSwicher) {
        ...
        colorSwicher.addEventListener('click', () => {
            ...
            const currentMode = colorSwicher.firstElementChild?.attributes.getNamedItem('data-mode')?.value ?? getPreferredTheme();
            // меняем тему
        ...
        console.error('Не найден элемент "button" с классом "color-switcher"!');
