...
function colorSwitcher() {
    ...
    const setTheme = (theme) => {
        if (theme === 'dark' || (!theme && window.matchMedia('(prefers-color-scheme: dark)').matches)) {
            ...
            // document.documentElement.setAttribute('data-bs-theme', 'dark') // for bootstrap
        }
        else {
            document.documentElement.classList.remove('dark'); // for tailwind
            // document.documentElement.setAttribute('data-bs-theme', 'light') // for bootstrap
        }
    };
